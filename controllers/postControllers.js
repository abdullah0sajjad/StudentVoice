...
module.exports.createPost = async (req, res)=>{
    ...
    form.parse(req, (err, fields, files) => {
        ...
        if (errors.length !== 0) {
            ...
            const newPath = __dirname + `/../student_voice_react/public/images/${files.image.name}`;
...
module.exports.PostLikes = async (req, res)=>{
    ...
    try {
        ...
        if (liked) {
            ...
            user.notifications.push({notificationUser: userId, notification: msg, isRead: false });
            await user.save();
        }
...
module.exports.commentPost = async (req, res)=>{
    ...
    form.parse(req, async (err, fields, files) => {
        ...
        const {userId, comment, postUser} = fields;
