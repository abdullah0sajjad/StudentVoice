    ...
    <>
      ...
      <div className="home-screen">
        <div className="left-side w-12 lg:w-7 xl:w-7">
          ...
          <div className='w-12 flex mb-3'>
            {user ? <button onClick={()=> history.push('/create-post', {loc: history.location.pathname})} className='w-11 sm:w-9 md:w-8 lg:w-8 xl:w-7 text-2xl font-bold border-round-3xl px-7 mx-auto shadow-3 p-2' style={{background: '#222d82', color: 'white'}} ><FaRegEdit className='text-4xl mb-1 mr-3' />   Create Post</button> : ''}
          </div>
          <div className=''>
            <FetchAllPost />
          </div>
